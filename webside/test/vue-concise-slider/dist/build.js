!function (t, e) {
    ...
    return function (t) {
        ...
        t.exports = " <div> <slider :pages=someList :sliderinit=sliderinit @slide=slide> </slider> <div class=sliderButton> <button @click=slidePre>上一页</button> <button @click=slideNext>下一页</button> <button @click=appendslider>添加一页</button> <button @click=turnTo(2)>跳转到第三页</button> </div> </div> "
    }, function (t, e, i) {
        var n, s, r = {};
