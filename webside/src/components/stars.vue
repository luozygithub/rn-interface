<template>
  <div class="stars-box">
    ...
    <div class="shooting_star"></div>
    <div class="shooting_star"></div>
    <div class="shooting_star shooting_star2"></div>
    <div class="shooting_star shooting_star3"></div>
    <div class="shooting_star shooting_star2 "></div>
    <div class="shooting_star shooting_star2 "></div>
    <div class="shooting_star shooting_star3 "></div>
    <div class="shooting_star shooting_star3 "></div>
...
.stars-box {
  ...
  .shooting_star{
    ...
    height: 3.75rem;
    width: .45rem;
    background: url(../assets/imgs/meteor.png) no-repeat;
    background-size: 100% 100%;
    -webkit-animation: 3s tail 2s ease-in-out infinite, 1s shooting 0.5s ease-in-out infinite;
    animation: 3s tail 2s ease-in-out infinite, 1s shooting 5s ease-in-out infinite;
  }
  .shooting_star2{
    opacity: 0;
    position: absolute;
    ...
    height: 3.75rem;
    width: .45rem;
    background: url(../assets/imgs/meteor2.png) no-repeat;
    background-size: 100% 100%;
    -webkit-animation: 3s tail 2s ease-in-out infinite, 1s shooting 0.5s ease-in-out infinite;
    animation: 3s tail 2s ease-in-out infinite, 1s shooting 5s ease-in-out infinite;
  }
  .shooting_star3{
    ...
    height: 3.75rem;
    width: .45rem;
    background: url(../assets/imgs/meteor3.png) no-repeat;
    background-size: 100% 100%;
    -webkit-animation: 3s tail 2s ease-in-out infinite, 1s shooting 0.5s ease-in-out infinite;
    animation: 3s tail 2s ease-in-out infinite, 1s shooting 5s ease-in-out infinite;
  }
